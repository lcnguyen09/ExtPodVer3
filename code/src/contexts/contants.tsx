...
export const URL_AUTH_SALEHUNTER = APP_MODE === 'dev' ? "http://localhost:3201/api/v1/auth" : "https://api-account.salehunter.io/api/v1/auth"

export const URL_ACCOUNT_GRAPHQL_PODORDER = APP_MODE === 'dev' ? "http://localhost:3201/graphql" : "https://api-account.podorders.store/graphql"

export const URL_ACCOUNT_GRAPHQL_SALEHUNTER = APP_MODE === 'dev' ? "http://localhost:3201/graphql" : "https://api-account.salehunter.io/graphql"
