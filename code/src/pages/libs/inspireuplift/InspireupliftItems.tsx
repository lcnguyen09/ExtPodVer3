...
import $ from 'jquery';
import { cloneDeep, filter, find, flatMapDeep, get, head, map, startsWith, toLower, toUpper, trim, set, findIndex } from 'lodash';
...
export default function ({ Identifier, storeData, setOnMulti }: any) {
    ...
    const handleFillData = async () => {
		...
		titleReplace = titleReplace.replaceAll(/[\~\`\@\#\$\%\^\+\=\{\}\[\]\;\<\>\?]/gi, '')
